...
public class RestControll {
    ...
    public Images getImage(@PathVariable String id) {
    ...
    public Images updateImage(@RequestBody Images update,@PathVariable String id) {
    ...
    public Images updateImageAddLike(@RequestBody Images update,@PathVariable String id) {
        Images images= baseImagesRepository.findOne(id);
        images.setUpdateDate(new Date(System.currentTimeMillis()));
    ...
    public Images updateImageAddDisLike(@RequestBody Images update,@PathVariable String id) {
        Images images= baseImagesRepository.findOne(id);
        images.setUpdateDate(new Date(System.currentTimeMillis()));
    ...
    public Images updateImageAddTag(@RequestBody Images update,@PathVariable String id,@PathVariable String tag) {
        Images images= baseImagesRepository.findOne(id);
        images.setUpdateDate(new Date(System.currentTimeMillis()));
        images.addTag(tag);
        return baseImagesRepository.save(images);
